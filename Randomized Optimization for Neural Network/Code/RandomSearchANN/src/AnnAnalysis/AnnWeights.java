...
public class AnnWeights {
	private static final int[] layers = {10, 5, 2, 1};
	
	/**
	 * main function to generate data for analysis
	 * @param args
	 */
    public static void main(String[] args) {
       ...
       for (int i = 2; i < 21; i += 2){
    	   System.out.println("RHC_validation_iter: " + i);
    	   numberOfRuns.add(i);
       ...
       for (double i = 0.1; i < 1.0; i += 0.1){
    	   System.out.println("SA_validation_cooling value: " + i);
       ...
       for (int i = XTrain.size()/10; i < XTrain.size(); i += XTrain.size()/10){
    	   System.out.println("GA_validation_toMutate: " + i);
       ...
       bp.trainModel(trainData);
   	   metrics(name + "Test", bp.predict(XTest), yTest);
	   System.out.println("Train and predict with BP: " + 
	                      (System.nanoTime() - startTimeBP) / 1E9 + " seconds");
	   ...
	   System.out.println("Best runs: " + bestRuns);
       ...
       System.out.println("Best cooling value: " + bestCooling);
       
	   // apply for GA
       long startTimeGA = System.nanoTime();
	   List<Integer> paramsGATest = new ArrayList<>();
   	   paramsGATest.add(XTrain.size()/10);
	   paramsGATest.add(XTrain.size()/10);
       ...
       System.out.println("Best number of mutate: " + bestMutate);
	   
    }
   
    /**
     * instance function to create instance for classifier
     * @param labels
     * @param features
     * @return
     */
    ...
    /**
     * metrics function to compute accuracy, precision, 
     * recall and f1 score for the prediction
     * @param name
     * @param results
     * @param labels
     * @return
